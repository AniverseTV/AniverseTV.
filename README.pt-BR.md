...
<p align="center">
  <a href="https://github.com/AniverseTV/AniverseTV./releases/download/v0.2.1/AniVerseTV-0.2.1-Ne-Ki.apk">
...
| --- | --- | --- | --- |
| Android Mobile | **0.2.1** | Ne · Ki | [Baixar APK](https://github.com/AniverseTV/AniverseTV./releases/download/v0.2.1/AniVerseTV-0.2.1-Ne-Ki.apk) |
...
| Google TV | Versão futura | — | Planejada |
| Fire TV | Versão futura | — | Planejada |

Use a versão Mobile mais recente, salvo quando precisar de uma versão antiga para testes de compatibilidade. Os pacotes para TV receberão botões próprios quando existirem builds oficiais.

## Instalação

1. Baixe o APK mais recente pelo botão abaixo ou na aba [Releases](https://github.com/AniverseTV/AniverseTV./releases/latest).
2. Abra o arquivo `AniVerseTV-0.2.1-Ne-Ki.apk` e, se o Android pedir, permita a instalação de apps de fontes
...
<p align="center">
  <a href="https://github.com/AniverseTV/AniverseTV./releases/download/v0.2.1/AniVerseTV-0.2.1-Ne-Ki.apk">
    <img src="https://img.shields.io/badge/Baixar_0.2.1_Ne_Ki-8979F2?style=for-the-badge&logo=android&logoColor=white" alt="Baixar AniVerseTV 0.2.1 Ne Ki" />
  </a>
</p>
